...
const peopleData = {
    ...
    'riverson': {
        ...
        image: '../assests/img/Riverson Oppong.jpeg',
        bio: [
    ...
    'yetunde': {
        ...
        title: 'Breakout Session Leader',
        focus: 'Petroleum Engineering Leadership',
        image: '../assests/img/yetunde.jpeg',
        bio: [
        ...
        contributionText: 'Dr. Aladeitan brings a rare combination of academic depth, consulting insight, and professional body leadership, with strong expertise across petroleum engineering, sustainability, and talent development.',
        highlightsTitle: 'Key Highlights',
        highlights: [
            'Fellow of both the Nigerian Society of Engineers and the Nigerian Society of Chemical Engineers',
            'Associate Professor at the University of Abuja with active teaching roles across multiple institutions',
            'National Chairman of the Nigerian Institution of Petroleum Engineers',
            'Experienced consultant and researcher in reservoir optimisation, environmental compliance, and sustainable energy'
        ],
        section: 'Breakout',
        category: 'Expert',
        contact: 'yetunde.aladeitan@spe.org',
        linkedin: 'https://linkedin.com/company/spe'
    },
    'chisom-breakout': {
        name: 'Engr. Chisom Njoku',
        role: 'Founder & Managing Consultant, Somit Integrated Services',
        title: 'Breakout Session Leader',
        focus: 'ICT, SaaS & Digital Innovation',
        image: '../assests/img/chisom.jpeg',
        bio: [
            'Chisom Njoku is a trained engineer, innovative entrepreneur, and seasoned consultant. He holds a Bachelor of Engineering degree in Electrical and Electronics Engineering and a Master of Science degree in Information and Telecommunications Engineering, both from the University of Port Harcourt.',
            'Engr. Njoku has over nine years of certified experience in ICT, Software as a Service, SaaS, and Digital Marketing. He is the visionary Founder and Managing Consultant of Somit Integrated Services, a fast-growing IT and digital media consultancy company he started as a university undergraduate.',
            'His expertise has been sought after by esteemed organisations such as the World Bank Africa Centre of Excellence, University of Port Harcourt, Baker Hughes, UNICEF WASH Project, and numerous corporate entities. He is also a visiting industry lecturer in four centres and two institutes within the University of Port Harcourt, where he teaches ICT and computing-related courses to postgraduate students.',
            'During the COVID period, he led a vibrant team that supported companies and institutions in e-learning digitisation and e-documentation of their operations for flexibility and seamless remote work integration. A well-experienced sales coach and brand innovator, Chisom has empowered individuals and businesses to achieve exceptional growth through B2B solutions, high-level training, and hands-on workshops.'
        ],
        contributionTitle: 'Digital Growth & Innovation',
        contributionText: 'Engr. Njoku brings practical insight into ICT strategy, SaaS, digital marketing, and enterprise transformation, with a strong track record of helping organisations modernise and scale effectively.',
        highlightsTitle: 'Key Highlights',
        highlights: [
            'Over nine years of certified experience in ICT, SaaS, and digital marketing',
            'Founder of Somit Integrated Services, launched while still an undergraduate',
            'Consulting experience with organisations including Baker Hughes, UNICEF WASH, and the World Bank Africa Centre of Excellence',
            'Industry lecturer and trainer supporting digital skills development and business growth'
        ],
        section: 'Breakout',
        category: 'Expert',
        contact: 'chisom.njoku@spe.org',
        linkedin: 'https://linkedin.com/company/spe'
    },
    'excel-breakout': {
        name: 'Dr Excel Ukpohor',
        role: 'Manager, Digital & Innovation, NLNG',
        title: 'Breakout Session Leader',
        focus: 'Digital Innovation',
        image: '../assests/img/excel.jpeg',
        bio: 'Dr Excel Ukpohor serves as Manager, Digital & Innovation at NLNG and joins the breakout session lineup to share insights on digital transformation and innovation in the energy industry.',
        contributionTitle: 'Digital Transformation Insight',
        contributionText: 'Dr Excel Ukpohor brings practical leadership experience in digital innovation within the LNG and broader energy space.',
        highlightsTitle: 'Profile Highlights',
        highlights: [
            'Manager, Digital & Innovation at NLNG',
            'Featured breakout session speaker',
            'Focus on innovation and digital transformation'
        ],
        section: 'Breakout',
        category: 'Expert',
        contact: 'excel.ukpohor@spe.org',
        linkedin: 'https://linkedin.com/company/spe'
    },
    'iroghama': {
        name: 'Iroghama Ogbeifun',
        role: 'Managing Director & CEO, Starzs Investments Company Limited',
        title: 'Fireside Chat Speaker',
        focus: 'Business Leadership & Maritime Strategy',
        ...
        highlights: [
            ...
            'Vice Chairman of Starzs Gas Limited and member of multiple industry and governance boards',
            'Founding Member and Sponsorship Director of the Women in Energy Network',
            'Winner of The Next Titan and recipient of multiple entrepreneurship and leadership awards'
        ],
    ...
    'jaja': {
        ...
        focus: 'Process Modelling & Simulation',
        image: '../assests/img/jaja.jpeg',
        bio: [
        ...
        category: 'Educator',
        contact: 'jaja@spe.org',
        linkedin: 'https://linkedin.com/company/spe'
    },
    'emmanuel-uma': {
        name: 'Engr. Emmanuel Uma Nwabueze',
        role: 'Team Lead, VAST Integrated Solutions Ltd',
        title: 'Short Course Instructor',
        focus: 'CADs, Plants & Project Management',
        image: '../assests/img/Nwabueze Emmanuel Uma.jpeg',
        bio: [
        ...
        section: 'Short Courses',
        category: 'Consultant',
        contact: 'emmanuel.nwabueze@spe.org',
        linkedin: 'https://linkedin.com/company/spe'
    },
    'oloruntoba-course': {
        name: 'Oloruntoba Isehunwa',
        role: 'Lead, Wells Engineer Performance and Planning, Renaissance Africa Energy Company',
        title: 'Short Course Instructor',
        focus: 'Wells Performance & Planning',
        image: '../assests/img/Oloruntoba Isehunwa (1).jpeg',
        bio: [
        ...
        highlightsTitle: 'Key Highlights',
        highlights: [
            'Lead Wells Engineer Performance and Planning at Renaissance Africa Energy Company',
            'Certified trainer and accredited IWCF Assessor and Instructor',
            'Experienced in drilling, completions, and workover activities across complex projects',
            'Founder of IgnitePro Community and active mentor to young professionals'
        ],
        section: 'Short Courses',
        category: 'Expert',
        contact: 'oloruntoba.isehunwa@spe.org',
        linkedin: 'https://linkedin.com/company/spe'
    },
    'promise': {
        name: 'Promise Amaechi',
        role: 'Co-Founder, HP Analytics',
        title: 'Short Course Instructor',
        focus: 'Data Science, AI & Analytics',
        image: '../assests/img/Amaechi Promise Chigozie- Passport (1).png',
        bio: [
        ...
        highlightsTitle: 'Key Highlights',
        highlights: [
            'Over seven years delivering data-driven solutions across multiple industries',
            'Experienced with Python, R, SQL, Power BI, TensorFlow, PyTorch, FastAPI, and AWS',
            'Co-Founder of HP Analytics and educator at Sobani Resources',
            'Research focus on ethical AI and algorithmic fairness in African healthcare'
        ],
        section: 'Short Courses',
        category: 'Specialist',
